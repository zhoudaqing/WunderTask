...
- (void)changeCircleViewStyle:(CircleViewStyle)style
{
    if (style == CircleViewStyleBegin ||
        ...
        _titleLabel.textColor = [UIColor jd_lineColor];
        _percentLabel.textColor = [UIColor jd_lineColor];
        
        _backLayer.strokeColor = [UIColor jd_backgroudColor].CGColor;
    }
...
- (void)toucheUpEvent:(NSSet *)touches
{
    if ([self isTouchUpIn:touches]) {
        self.backLayer.fillColor = [UIColor jd_backgroudColor].CGColor;
    }else {
        self.backLayer.fillColor = [UIColor whiteColor].CGColor;
    }
}
