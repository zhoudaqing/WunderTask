...
- (id)initWithFrame:(CGRect)frame dataSource:(id)datasource delegate:(id) delegate
{
    ...
    if (self) {
        ...
        for (int i = 0; i <sectionNum; i++) {
            ...
            UIImageView *sectionBtnIv = [[UIImageView alloc] initWithFrame:CGRectMake(sectionWidth*i +(sectionWidth - 30), (self.frame.size.height-12)/2, 12, 12)];
        ...
        UIView *line = [Sundry   rimLine];
        line.frame = CGRectMake(0, 43.5, APPScreenWidth, .5);
