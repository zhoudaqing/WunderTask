...
- (void)setPageEnable:(BOOL)pageEnable
{
    ...
    _lastUpdateTimeLabel.hidden = pageEnable;
    _statusLabel.top += 10;
}

- (void)makeWhite
{
    self.lastUpdateTimeLabel.textColor = [UIColor whiteColor];
    self.statusLabel.textColor = [UIColor whiteColor];
    self.arrowImage.image = [UIImage imageNamed:kSrcName(@"arrowWhite")];
}
...
- (void)refreshContentInsetZero
{
    _scrollViewInitInset = UIEdgeInsetsZero;
}
...
{    
    ...
    if (_scrollView.isDragging || _isDragging) {
