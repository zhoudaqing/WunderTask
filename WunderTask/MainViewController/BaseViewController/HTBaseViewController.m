...
- (void)viewDidLoad
{
    ...
    //主题背景颜色
    self.view.backgroundColor = [UIColor jd_backgroudColor];
...
{
    [self presentGestureViewController:self.tabBarController];
}
...
#pragma mark - UserLoginViewController
...
{
    LogOrRegViewController *login = [[LogOrRegViewController alloc] init];
    HTNavigationController *nav = [[HTNavigationController alloc] initWithRootViewController:login];
    [login addHeadBtnType:Login];
